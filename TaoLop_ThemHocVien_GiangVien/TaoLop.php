...
<script>
    ...
    option.text = "----------Chọn Lớp----------";
    LoaiTK.add(option);
    var option = document.createElement("option");
    option.text = "TOEIC 2 Kỹ Năng";
    LoaiTK.add(option);
    var option = document.createElement("option");
    option.text = "TOEIC 4 Kỹ Năng";
    LoaiTK.add(option);
    var option = document.createElement("option");
    option.text = "Luyện Thi IELTS";
    LoaiTK.add(option);
    var option = document.createElement("option");
    option.text = "TIếng Anh Giao Tiếp";
    LoaiTK.add(option);
    var option = document.createElement("option");
    option.text = "Luyện Thi VNU-EPT";
    LoaiTK.add(option);
    ...
    cell4.style.border = "1px solid black";
    cell5.innerHTML = "<input type=\"password\" name=\"password\" id='password' class='input'>",
    cell5.style.border = "1px solid black";

    var row4 = table.insertRow();
    var cell6 = row4.insertCell(0);
    cell6.innerHTML = "<input type='submit' id='Them' name='submit' value='Tạo Lớp' onclick='checkTaoLop()'>";
    cell6.style.textAlign = "center";
    cell6.colSpan = 2;
    ...
    function getLoaiTaiKhoan(){
        ...
        if (text == "TOEIC 2 Kỹ Năng"){
            UserID.value = "TOEIC2" + id;
            mand.value = "TOEIC2" + id;
        }
        else if (text == "TOEIC 4 Kỹ Năng"){
            UserID.value = "TOEIC4" + id;
            mand.value = "TOEIC4" + id;
        }
        else if (text == "Luyện Thi IELTS"){
            UserID.value = "IELTS" + id;
            mand.value = "IELTS" + id;
        }
        else if (text == "TIếng Anh Giao Tiếp"){
            UserID.value = "GIAOTIEP" + id;
            mand.value = "GIAOTIEP" + id;
        }
        else if (text == "Luyện Thi VNU-EPT"){
            UserID.value = "VNU" + id;
            mand.value = "VNU" + id;
        }
        else {
...
<?php 
    if(isset($_POST['submit'])){
        ...
        if ($hidden == 0){
            ...
            $result = TaoLop($LoaiTK,$MaND,$hash);
            if($result == 1){ ?>
                <script> alert("Tạo Lớp Thành Công!"); </script>
            <?php }
        }
    }
?>
