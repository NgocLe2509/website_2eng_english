...
<?php
	...
	{
        $getMaLop = $_POST['STTBai'];
		header("Location:SuaBai.php?STTBai=$getMaLop");
	}
	if (isset($_POST['XemBaiNop']))
	{
        $getMaLop = $_POST['STTBai'];
		header("Location:XemBaiNop.php?STTBai=$getMaLop");
	}
...
<div id="Web_1366__1">
    ...
    <script>
        ...
        for (i = 0; i <baitaplop.length; i++) {
			...
			content += "</br><input id=\"NopBai\" type=\"submit\" name=\"submit\" value=\"Chỉnh Sửa\">";
			content += "<input id=\"XemBai\" type=\"submit\" name=\"XemBaiNop\" value=\"Xem Bài Nộp\">";
