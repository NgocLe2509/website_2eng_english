...
<title>Xem Bài Nộp</title>
<link rel="stylesheet" href="../css/XemBaiNop.css">
...
<?php
    ...
    $getBaiTapLop = check_BaiTapLop($STTBai, $_SESSION['MaLop']);
    if ($getBaiTapLop == 0){
...
<div id="Web_1366__1">
	...
	<a href="DanhSachLop.php"><rect id="Rectangle_21" rx="0" ry="0" x="0" y="0" width="397" height="44">
		</rect></a>
	</svg>
    ...
    <table id="Bi">
        <tr>
			<th colspan="4">DANH SÁCH BÀI NỘP</th>
  		</tr>
		<tr>
			<th>STT</th>
			<th>Mã HV</th>
	...
	<a href="./static_page/lotrinh650-800.php"><img id="khoa-hoc-toeic-650-2" src="../static_page/img/khoa-hoc-toeic-650-2.png"></a>
	<a href="./static_page/baithitoeic.php"><img id="L-trnh-n-thi-TOEIC--mi-t-500-i" src="../static_page/img/TOEIC-Test-Preparation-in-Canada.png"></a>
	...
	<?php 
        ...
        foreach ($getBaiNop as $item){
            ...
            <script>
                ...
                cell3.innerHTML = "<a href='download/download_BaiNop.php?filename=" + student.filename + "'>" + student.filename + "</a>"
	...
	<script>
		...
		var khaigiang = <?php echo json_encode($getBaiTapLop); ?>;
        ...
        context += "</br><b>Mã Bài: </b>";
		context += khaigiang.STT;
		context += "</br><b>Yêu Cầu: </b>";
		context += khaigiang.YeuCau;
		context += "</br><b>Mô Tả: </b>";
        context += khaigiang.MoTa;
        
        if (khaigiang.Filename != ""){
            context += "</br><b>File: </b>";
            context += "<a href='download/dowload_BaiTap.php?filename=" + khaigiang.Filename + "'>" + khaigiang.Filename + "</a>";
        }
